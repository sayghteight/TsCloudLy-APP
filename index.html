	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="" method="post" class="registration-form">
				                        ...
				                        <div class="form-group">
				                        	...
				                        	<input type="text" name="form-last-name" placeholder="Contraseña..." class="form-last-name form-control" id="form-last-name">
				                        </div>
				                        <div class="form-group">
				                        	<label class="sr-only" for="form-last-name">Escriba de nuevo la contraseña</label>
				                        	<input type="text" name="form-last-name" placeholder="Escriba de nuevo la contraseña..." class="form-last-name form-control" id="form-last-name">
				                        </div>
				                        <div class="form-group">
